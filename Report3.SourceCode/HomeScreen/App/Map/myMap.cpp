...
// Khởi tạo Vị trí và map plugin
MyMap::MyMap() {
  longitude = 10.851;
  latitude = 106.798;
  mapPlugin = "mapboxgl"; // "mapboxgl" //"osm" // , "esri", ...
}
...
void MyMap::setMapPlugin(QString setMapPlugin) { mapPlugin = setMapPlugin; }

qreal MyMap::getLongitude() { return longitude; }

qreal MyMap::getLatitude() { return latitude; }

QString MyMap::getMapPlugin() { return mapPlugin; }
